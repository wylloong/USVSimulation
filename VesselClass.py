...
class Vessels(object):
    ...
    def BoatMotionItera(self,iteraTime):
        self.Current_X += self.velocity * math.sin(self.direction / 180.0 * math.pi) * iteraTime  # 当前位置x
        self.Current_Y += self.velocity * math.cos(self.direction / 180.0 * math.pi) * iteraTime  # 当前位置y
